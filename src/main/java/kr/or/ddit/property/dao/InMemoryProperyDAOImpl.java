 ...
 *
 */
public class InMemoryProperyDAOImpl implements PropertyDAO {
	public Properties properties;
	public URL realPath;
	public InMemoryProperyDAOImpl(String logicalPath) {
		super();
		this.realPath = this.getClass().getResource(logicalPath);
		try {
