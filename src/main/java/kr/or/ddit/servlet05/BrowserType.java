...
//	private static final BrowserType EDG=new BrowserType("엣지");
//	private static final BrowserType WHALE=new BrowserType("웨일");
//	private static final BrowserType CHROME=new BrowserType("크롬");
//	
