 ...
 *  5. HttpSession : 한사람의 클라이언트 혹은 하나의 에이전트(브라우저)에 대한 고유 정보를 캡슐화한 객체.
 *  
 */
