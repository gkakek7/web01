...
<pre>
	...
	2. web resource : URL 이라는 논리 주소의 형태로 접근 가능. 
		...
		ex) http://localhost/WebStudy01/resorces/images/ala.jpg
										/resorces/images/ala.jpg
		<%
			String logicalPath="/resorces/images/ala.jpg";
...
URN (Uniform Resource Name) : 자원을 식별할때 명명된 이름으로 식별하는 방식.
URC (Uniform Resource Content) : 자원을 식별할때 해당 자원이 가진 컨텐츠의 특성으로 식별하는 방법.

URL - 절대경로
protocal://ip[domain]:port/context/depth.../resourceName

client side : context path를 포함한 경로 형태.
server side : context path 이후의 경로만 사용함.

<img src="http://localhost/WebStudy01/resorces/images/ala.jpg"/>
<img src="//localhost/WebStudy01/resorces/images/ala.jpg"/>
<img src="<%=request.getContextPath() %>/resorces/images/ala.jpg"/>
