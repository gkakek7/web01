...
<form action="formProcess.do" method="post" enctype="application/x-www-form-urlencoded">
	<pre>
		...
		<input type="checkbox" name="checekbox" value="CHECK1"/>CHECK1
		<input type="checkbox" name="checekbox" value="CHECK2"/>CHECK2
		<input type="checkbox" name="checekbox" value="CHECK3"/>CHECK3
